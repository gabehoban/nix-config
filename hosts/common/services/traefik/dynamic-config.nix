  ...
  services.traefik.dynamicConfigOptions = {
      ...
      stores = {
        default = {
          defaultGeneratedCert = {
            resolver = "cloudflare";
            domain = {
              main = "${tr_secrets.traefik.homelab_domain}";
              sans = [ "*.${tr_secrets.traefik.homelab_domain}" ];
            };
          };
        };
      };
    ...
    http = {
      ...
      services = {
        ...
        dashboard = {
          loadBalancer = {
            servers = [ { url = "http://10.1.8.129:8082"; } ];
            passHostHeader = "true";
          };
        };
        proxmox = {
          loadBalancer = {
            servers = [ { url = "https://10.3.29.2:8006"; } ];
            passHostHeader = "true";
          };
        };
        jellyfin = {
          loadBalancer = {
            servers = [ { url = "http://10.1.8.6:8096"; } ];
            passHostHeader = "true";
          };
        };
        unifi = {
          loadBalancer = {
            servers = [ { url = "https://10.1.8.1"; } ];
            passHostHeader = "true";
          };
        };
        truenas = {
          loadBalancer = {
            servers = [ { url = "https://10.1.8.4"; } ];
            passHostHeader = "true";
          };
        };
        ai = {
          loadBalancer = {
            servers = [ { url = "http://10.1.8.6:8080"; } ];
            passHostHeader = "true";
          };
        };
        gitea = {
          loadBalancer = {
            servers = [ { url = "http://10.2.1.245:3008"; } ];
            passHostHeader = "true";
          };
        };
        octoprint = {
          loadBalancer = {
            servers = [ { url = "http://10.1.8.6:5000"; } ];
            passHostHeader = "true";
          };
        };
        octostream = {
          loadBalancer = {
            servers = [ { url = "http://10.1.8.6:8081"; } ];
            passHostHeader = "true";
          };
        };
        syncthing = {
          loadBalancer = {
            servers = [ { url = "https://10.1.8.121:8384"; } ];
            passHostHeader = "true";
          };
        };
        traefik = {
          loadBalancer = {
            servers = [ { url = "https://10.1.8.129:8080"; } ];
            passHostHeader = "true";
          };
        };
        radicale = {
          loadBalancer = {
            servers = [ { url = "http://10.1.8.121:5232/"; } ];
            passHostHeader = "true";
          };
        };
      };
