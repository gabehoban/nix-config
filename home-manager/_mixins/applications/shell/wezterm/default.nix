{ inputs, lib, pkgs, ...}: {
  programs.wezterm = {
    ...
    extraConfig = ''
      ...
      -- local workspace_switcher = wezterm.plugin.require("file:///Users/gabehoban/Development/Projects/smart_workspace_switcher.wezterm")
      ...
      workspace_switcher.set_zoxide_path("/etc/profiles/per-user/gabehoban/bin/zoxide")
